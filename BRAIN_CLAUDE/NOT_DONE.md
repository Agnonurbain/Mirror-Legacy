...
| G1 | **Migration Godot — simulation Core** | 🔴 | Porter les systèmes par domaine (temps, clan, personnages, économie, diplomatie, événements, miroir, sauvegarde, victoire) en classes C# sans moteur ; `GameSession` comme racine de composition ; bus d'événements par session ; hasard injecté ; test de simulation de 100 ans. |
