...
| 2 | **Corriger erreurs de compilation** | 🔴 | Voir WL-001 à WL-005 dans `WORKED_LESSON.md`. 5 bugs : `deceased.RootElement`, `ConsumeMirrorPower`, `Element.Ice`, `GenerateYearlyEvent()`, `ProcessYearlyFactionAI()` privées appelées depuis GameSimulationTest. |
