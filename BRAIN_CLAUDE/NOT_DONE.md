...
| L4d | ~~Serments du Dao~~ | ✅ | Fait 2026-09-26 : pactes entre deux cultivateurs de toute voie (`oaths.json`), parjure = chemin interrompu ou Démon du Cœur, portes dérobées (tiers, prête-nom, échéance, voile du miroir, purification). Suites : réincarnation/conversion (L7), serments des factions, écran de pacte (G6). |
