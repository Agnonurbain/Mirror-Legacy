...
| 2026-09-25 | L2 : orifice spirituel héréditaire (D3), mortels 60-80 ans limités aux tâches non cultivatrices, examen par un cultivateur à l'Œil du Sommet, Graines de Sceau du miroir, blessures du Dao persistantes (`DaoWounds`). 164 tests purs verts. |
