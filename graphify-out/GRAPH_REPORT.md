...
## Corpus Check
- 167 files · ~118,697 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2689 nodes · 4382 edges · 164 communities (158 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 19 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9152322d`
...
1. `GoldenCoreTests` - 44 edges
2. `Test` - 35 edges
3. `ClanDomain` - 30 edges
4. `CultivationSystemTests` - 28 edges
5. `CombatActionsTests` - 28 edges
6. `TechniqueContentTests` - 26 edges
7. `PowerLadderTests` - 25 edges
8. `ClanManagerTests` - 25 edges
9. `ClanDomainViewTests` - 25 edges
10. `TechniqueRulesTests` - 24 edges
...
Cohesion: 0.07
Nodes (23): Button, Control, Chronicle, float, int, IReadOnlyList, MemberRow, Node (+15 more)

### Community 3 - "Test Infra & Asmdefs"
Cohesion: 0.16
Nodes (14): FactKind, KnowledgeSource, Fact, Func, GameContent, HashSet, IEnumerable, IReadOnlyList (+6 more)
...
Cohesion: 0.12
Nodes (16): MirrorChronicles.Characters, OathSystem, ClauseDefinition, LoopholeKind, OathAct, PactData, CharacterData, ClanManager (+8 more)

### Community 12 - "PlayMode Tests & Worked Lessons"
Cohesion: 0.11
Nodes (9): CombatActionsTests, MirrorChronicles.Tests.Combat, BattleField, CombatUnit, CultivationRealm, Element, TechniqueData, TechniqueEffect (+1 more)

### Community 13 - "Wounds & Techniques"
Cohesion: 0.15
Nodes (7): MirrorChronicles.Tests.Characters, TechniqueRulesTests, CultivationRealm, QiDefinition, TechniqueData, Test, TestCase

### Community 14 - "Save System (Newtonsoft)"
Cohesion: 0.22
Nodes (9): 5.1 Respiration Embryonnaire (6 chakras), 5.2 Culture du Qi (9 niveaux célestes), 5.5.1 Percée : demander une position au Ciel, 5.5.2 Pouvoirs, 5.5 Noyau d'Or (Vrai Monarque, 4 stades), 5.6 Embryon du Dao (Immortel), 5.7 Immortel Doré (Seigneur Immortel), 5.8 Au-delà des royaumes (📚) (+1 more)

### Community 15 - "Xianxia Rules & Aging"
Cohesion: 0.14
Nodes (9): FixedRandom, MarriageMatchmakerTests, MirrorChronicles.Tests.Clan, CharacterData, Dictionary, double, Random, SetUp (+1 more)
...
Cohesion: 0.09
Nodes (27): GameContentLoader, MirrorChronicles.Data, Fields, FruitionCatalog, Id, OathCatalog, BalanceSettings, ClanDefinition (+19 more)
...
Cohesion: 0.17
Nodes (10): MirrorChronicles.Characters, TechniqueRules, BalanceSettings, CharacterData, CultivationRealm, int, IReadOnlyList, QiDefinition (+2 more)
...
Cohesion: 0.24
Nodes (7): MentalStabilitySystem, MirrorChronicles.Characters, CharacterData, ClanManager, DeathCause, GameContext, int

### Community 29 - "Resource Manager"
Cohesion: 0.11
Nodes (6): MirrorChronicles.Economy, ResourceManager, Action, Dictionary, GameContext, IReadOnlyDictionary

### Community 30 - "Turn Manager"
Cohesion: 0.19
Nodes (10): BreakthroughSystemTests, MirrorChronicles.Tests.Characters, BreakthroughSystem, CharacterData, ClanManager, double, GameContext, Random (+2 more)

### Community 31 - "Blood Registry"
Cohesion: 0.31
Nodes (4): BloodRegistry, MirrorChronicles.Clan, CharacterData, List
...
Cohesion: 0.29
Nodes (4): BuildingData, MirrorChronicles.Data, BuildingType, CultivationRealm

### Community 35 - "Game Manager"
Cohesion: 0.18
Nodes (7): BreakthroughRulesTests, MirrorChronicles.Tests.Characters, BreakthroughOutcome, CharacterData, CultivationRealm, Test, TestCase

### Community 36 - "Time Manager"
Cohesion: 0.12
Nodes (10): CultivationSystemTests, MirrorChronicles.Tests.Characters, CharacterData, ClanKarmaSystem, CultivationSystem, GameContext, ResourceManager, SetUp (+2 more)

### Community 37 - "UI Theme Data"
Cohesion: 0.22
Nodes (5): GameContentLoaderTests, MirrorChronicles.Tests.Data, Func, Test, TestCase
...
Cohesion: 0.16
Nodes (9): MentalStabilitySystemTests, MirrorChronicles.Tests.Characters, CharacterData, ClanManager, GameContext, MentalStabilitySystem, SetUp, Test (+1 more)

### Community 43 - "Community 43"
Cohesion: 0.21
Nodes (9): CombatGrid, MirrorChronicles.Combat, Dictionary, double, GridCell, int, List, Random (+1 more)
...
Cohesion: 0.13
Nodes (9): MirrorChronicles.Characters, PowerLadder, AdvancementStep, CharacterData, CultivationRealm, double, int, QiPhase (+1 more)

### Community 47 - "Community 47"
Cohesion: 0.21
Nodes (6): MirrorChronicles.Tests.Economy, TaskAssignmentSystemTests, CharacterData, TaskType, Test, TestWorld
...
Cohesion: 0.22
Nodes (6): MirrorChronicles.Characters, RankCatalog, CharacterData, CultivationRealm, QiPhase, string

### Community 51 - "Community 51"
Cohesion: 0.22
Nodes (9): 📁 Arborescence, 🏗️ Architecture, 📌 Contexte projet, 📝 Conventions de code, 🎨 Direction artistique (rappel), 📋 Fichiers de suivi, 🧠 MEMORY.md — Mémoire projet Reflets de Lignée, 🧭 Où en est le projet (+1 more)

### Community 52 - "Community 52"
Cohesion: 0.31
Nodes (7): KinshipRules, MirrorChronicles.Clan, CharacterData, Func, HashSet, int, List
...
Cohesion: 0.22
Nodes (7): BreakthroughRules, MirrorChronicles.Characters, BreakthroughOutcome, CharacterData, float, int, TrialKind
...
Cohesion: 0.25
Nodes (7): MirrorChronicles.Tests.Characters, WoundSystemTests, CharacterData, Random, Test, TestCase, WoundSystem
...
Cohesion: 0.20
Nodes (9): 🛠️ CLI.md — Commandes de développement (Godot 4.7.2 .NET, Linux), Construire, tester, lancer, Git, Graphe de connaissances, Unity bootstrap via temporary Universal 2D project merge, WL-008: Repository was not a valid Unity project, Unity 6000.4.2f1 (Unity 6.4), Unity 2022.3 LTS (README stack, outdated) (+1 more)
...
Cohesion: 0.20
Nodes (8): GeneticSystemTests, MirrorChronicles.Tests.Clan, CharacterData, Element, int, Random, SetUp, Test

### Community 71 - "Community 71"
Cohesion: 0.18
Nodes (5): CombatGridTests, MirrorChronicles.Tests.Combat, TerrainType, Test, TestCase
...
Cohesion: 0.18
Nodes (9): FactionManagerTests, MirrorChronicles.Tests.Diplomacy, faction, FactionData, FactionPersonality, Test, TestCase, TestWorld (+1 more)
...
Cohesion: 0.13
Nodes (16): MirrorChronicles.Characters, PurpleMansionRules, PurpleMansionSystem, ForLife, PurpleMansionSettings, CharacterData, ClanManager, CultivationSystem (+8 more)
...
Cohesion: 0.12
Nodes (11): CLAUDE.md / master prompt (source of truth), WorldMap scene (#42), Scenes: MainMenu, ClanDomain, TacticalCombat, WorldMap, Phase 3 - World & Diplomacy, Victory: 10 generations + Dao Embryo ascension, WL-101: Factions hardcoded instead of ScriptableObjects, AscensionSystem, MirrorChronicles.Characters (+3 more)

### Community 85 - "Community 85"
Cohesion: 0.33
Nodes (6): MirrorChronicles.Characters, TaskRules, CharacterData, int, IReadOnlyList, TaskType
...
Cohesion: 0.12
Nodes (16): Key Xianxia business rules, Player as consciousness trapped in ancestral bronze mirror, Six cultivation realms (Embryonic -> DaoEmbryo), Ironman save (yearly auto-save JSON), WL-001: deceased.RootElement does not exist (use Affinity), WL-002: MirrorSystem.ConsumeMirrorPower does not exist (ConsumePower), WL-003: Element.Ice missing from Element enum, WL-004: EventManager.GenerateYearlyEvent missing / TriggerYearlyEvent private (+8 more)

### Community 89 - "Community 89"
Cohesion: 0.22
Nodes (8): AllianceSystemTests, MirrorChronicles.Tests.Diplomacy, faction, FactionData, FactionPersonality, Test, TestWorld, world

### Community 90 - "Community 90"
Cohesion: 0.22
Nodes (3): MirrorChronicles.Tests.Mirror, MirrorSystemTests, Test

### Community 91 - "Community 91"
Cohesion: 0.20
Nodes (5): MirrorChronicles.Tests.Session, SaveSerializerTests, GameSession, Test, TestCase

### Community 92 - "Community 92"
Cohesion: 0.21
Nodes (8): MirrorChronicles.Tests.Session, SimulationTests, Action, GameSession, IEnumerable, int, Test, TestCase

### Community 93 - "Community 93"
Cohesion: 0.20
Nodes (9): ascension, MirrorChronicles.Tests.Session, VictoryConditionSystemTests, AscensionSystem, Test, TestWorld, world, victory (+1 more)
...
Cohesion: 0.20
Nodes (6): ChronicleTests, MirrorChronicles.Tests.Presentation, Chronicle, GameSession, SetUp, Test
...
Cohesion: 0.19
Nodes (7): AgingSystem, AgingSystemTests, MirrorChronicles.Tests.Characters, ClanManager, GameContext, SetUp, Test

### Community 103 - "Community 103"
Cohesion: 0.23
Nodes (4): MirrorChronicles.Tests.Characters, TaskRulesTests, int, Test

### Community 104 - "Community 104"
Cohesion: 0.24
Nodes (7): LegacySystemTests, MirrorChronicles.Tests.Clan, legacy, LegacySystem, Test, TestWorld, world

### Community 105 - "Community 105"
Cohesion: 0.26
Nodes (8): CombatFixtures, MirrorChronicles.Tests.Combat, AIStrategyType, BattleField, CombatUnit, CultivationRealm, Element, Random

### Community 106 - "Community 106"
Cohesion: 0.27
Nodes (3): MarriageSystemTests, MirrorChronicles.Tests.Diplomacy, Test

### Community 107 - "Community 107"
Cohesion: 0.20
Nodes (5): IGameLog, MirrorChronicles.Session, NullGameLog, RecordingGameLog, List

### Community 108 - "Community 108"
Cohesion: 0.21
Nodes (7): MirrorChronicles.Session, RandomExtensions, Element, int, IReadOnlyList, Random, T

### Community 109 - "Community 109"
Cohesion: 0.20
Nodes (7): AscensionSystemTests, MirrorChronicles.Tests.Characters, AscensionSystem, ClanManager, GameContext, SetUp, Test

### Community 110 - "Community 110"
Cohesion: 0.29
Nodes (3): CombatAITests, MirrorChronicles.Tests.Combat, Test
...
Cohesion: 0.33
Nodes (3): MirrorChronicles.Tests.Combat, TurnOrderTests, Test

### Community 116 - "Community 116"
Cohesion: 0.33
Nodes (3): GameClockTests, MirrorChronicles.Tests.Session, Test

### Community 117 - "Community 117"
Cohesion: 0.29
Nodes (4): BloodRegistryTests, MirrorChronicles.Tests.Clan, Test, TestCase

### Community 118 - "Community 118"
Cohesion: 0.29
Nodes (5): MirrorChronicles.Combat, TurnOrder, CombatUnit, List, Queue

### Community 119 - "Community 119"
Cohesion: 0.18
Nodes (8): DivineAbilityTests, MirrorChronicles.Tests.Characters, CharacterData, double, string, Test, TestCase, TestWorld
...
Cohesion: 0.13
Nodes (14): BalanceSettings, ClanDefinition, DivineAbilitySettings, FounderDefinition, GoldenCoreSettings, MirrorChronicles.Data, NamePools, OrificeOdds (+6 more)

### Community 122 - "Community 122"
Cohesion: 0.29
Nodes (5): Chronicle, MirrorChronicles.Presentation, GameSession, int, List

### Community 123 - "Community 123"
Cohesion: 0.33
Nodes (4): MirrorChronicles.Session, SaveSerializer, GameData, JsonSerializerSettings
...
Cohesion: 0.33
Nodes (3): IGameLog, GodotGameLog, MirrorChronicles.Game

### Community 127 - "Community 127"
Cohesion: 0.33
Nodes (3): GameClock, MirrorChronicles.Session, GamePhase

### Community 128 - "Community 128"
Cohesion: 0.40
Nodes (5): Commandes, Les niveaux de tests, Revue, 🧪 TEST.md — Règles de tests, Écrire un test

### Community 129 - "Community 129"
Cohesion: 0.40
Nodes (3): AgingSystem, MirrorChronicles.Characters, ClanManager

### Community 130 - "Community 130"
Cohesion: 0.50
Nodes (4): Outils, 📦 PACKAGE.md — Dépendances, Paquets NuGet, Règles

### Community 131 - "Community 131"
Cohesion: 0.50
Nodes (3): GameData, MirrorChronicles.Data, string

### Community 135 - "Community 135"
Cohesion: 0.19
Nodes (7): MirrorChronicles.Tests.Data, TechniqueDataTests, TechniqueData, TechniqueEffect, TechniqueKind, Test, TestCase

### Community 136 - "Community 136"
Cohesion: 0.24
Nodes (6): MirrorChronicles.Tests.Characters, PurpleMansionTests, CharacterData, double, Test, TestWorld

### Community 137 - "Community 137"
Cohesion: 0.29
Nodes (7): 5.9 Toutes les routes vers le Noyau d'Or — couverture en gameplay (validation demandée le 2026-09-25), A. Dao du Noyau d'Or du Manoir Pourpre (voie du clan), B. Les autres voies (le clan peut s'y convertir ou y engager des membres), C. Cas exceptionnels (fin de partie), D. Ce qui ne mène **pas** au Noyau d'Or (à ne pas confondre), E. Facteurs transverses (tous jouables), F. Conséquences pour le modèle de données (dès L1)

### Community 138 - "Community 138"
Cohesion: 0.33
Nodes (6): 5.3.1 Percée, 5.3.2 Progression, 5.3.3 Partenaires Dao, 5.3.4 Blocage au Manoir Pourpre, 5.3.5 Phénomènes, 5.3 Établissement des Fondations (4 stades)

### Community 139 - "Community 139"
Cohesion: 0.33
Nodes (6): 5.4.1 Percée (quatre épreuves successives), 5.4.2 Voies de contournement, 5.4.3 Progression : cinq capacités divines, 5.4.4 Types de capacités divines, 5.4.5 Phénomène à l'échec, 5.4 Manoir Pourpre (4 stades)

### Community 140 - "Community 140"
Cohesion: 0.22
Nodes (9): DivineAbilitySystem, MirrorChronicles.Characters, CharacterData, ClanManager, GameContext, int, QiDefinition, ResourceManager (+1 more)

### Community 141 - "Community 141"
Cohesion: 0.20
Nodes (9): FoundationRules, MirrorChronicles.Characters, BalanceSettings, CharacterData, DivineAbilityDefinition, FruitionDefinition, IReadOnlyList, Random (+1 more)
...
Cohesion: 0.18
Nodes (6): FruitionStatus, GameSession, Test, TestCase, FruitionRegistryTests, MirrorChronicles.Tests.World

### Community 144 - "Community 144"
Cohesion: 0.18
Nodes (4): Fact, Test, KnowledgeTests, MirrorChronicles.Tests.World

### Community 145 - "Community 145"
Cohesion: 0.20
Nodes (8): AbilityId, DivineAbilityDefinition, FoundationRef, FruitionCatalog, FruitionDefinition, FruitionOdds, MirrorChronicles.Data, FruitionId

### Community 146 - "Community 146"
Cohesion: 0.09
Nodes (10): GoldenCoreTests, MirrorChronicles.Tests.Characters, CharacterData, double, FruitionDefinition, PositionRoute, string, Test (+2 more)
...
Cohesion: 0.18
Nodes (10): EspionageSystem, EspionageResult, CharacterData, DeductionEngine, double, FactionData, FactionManager, GameContext (+2 more)
...
Cohesion: 0.19
Nodes (7): LeftHandTests, MirrorChronicles.Tests.Characters, CharacterData, double, string, Test, TestWorld
...
## Knowledge Gaps
- **850 isolated node(s):** `net8.0`, `Godot.NET.Sdk/4.7.2`, `MirrorChronicles.Game`, `int`, `float` (+845 more)
...
- **Why does `CLAUDE.md / master prompt (source of truth)` connect `Community 84` to `Community 88`, `BRAIN_CLAUDE Workflow`, `Conventions & Event Bus`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `Session start reading order` connect `BRAIN_CLAUDE Workflow` to `Community 84`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `Annual 4-phase cycle (Management -> Events -> Breakthrough -> Inheritance)` connect `Community 78` to `Community 152`, `Community 84`, `Community 158`?**
