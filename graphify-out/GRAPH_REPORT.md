...
## Corpus Check
- 176 files · ~126,794 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2822 nodes · 4624 edges · 170 communities (163 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 19 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e2ebbe75`
...
6. `TechniqueContentTests` - 27 edges
...
Cohesion: 0.05
Nodes (31): Button, Control, Chronicle, float, GameRoot, int, IReadOnlyList, Label (+23 more)
...
Cohesion: 0.09
Nodes (28): GameContentLoader, MirrorChronicles.Data, Fields, FruitionCatalog, Id, OathCatalog, BalanceSettings, ClanDefinition (+20 more)
...
Cohesion: 0.15
Nodes (9): CLAUDE.md / master prompt (source of truth), Ironman save (yearly auto-save JSON), Victory: 10 generations + Dao Embryo ascension, WL-101: Factions hardcoded instead of ScriptableObjects, AscensionSystem, MirrorChronicles.Characters, FactionData, MirrorChronicles.Data (+1 more)
...
Cohesion: 0.17
Nodes (8): MirrorChronicles.Tests.Data, RegionContentTests, Action, JArray, JObject, RegionDefinition, Test, TestCase
...
Cohesion: 0.19
Nodes (9): FactionKind, MapFaction, MirrorChronicles.Presentation, WorldMapView, FactionData, GameSession, IReadOnlyList, MapBorder (+1 more)

### Community 166 - "Community 166"
Cohesion: 0.29
Nodes (6): Key Xianxia business rules, WorldMap scene (#42), Six cultivation realms (Embryonic -> DaoEmbryo), Scenes: MainMenu, ClanDomain, TacticalCombat, WorldMap, Phase 3 - World & Diplomacy, MirrorChronicles.Diplomacy
...
## Knowledge Gaps
- **888 isolated node(s):** `net8.0`, `Godot.NET.Sdk/4.7.2`, `MirrorChronicles.Game`, `string`, `int` (+883 more)
...
- **Why does `CLAUDE.md / master prompt (source of truth)` connect `Community 84` to `BRAIN_CLAUDE Workflow`, `Conventions & Event Bus`, `Community 166`?**
